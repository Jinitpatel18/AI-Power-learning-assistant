...
import { Plus, BarChart2, Trash2, Award } from 'lucide-react'
            ...
            <div className='mt-2 pt-4 border-t border-slate-100'>
                {quiz?.userAnswers?.length > 0 ? (
                    ...
                    <Link to={`/quizzes/${quiz._id}`}>
                        <button className='group/btn relative w-full h-11 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold text-sm rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500 active:scale-95 overflow-hidden'>
