        ...
        <>
            ...
            <aside
                ...
                <nav className='flex-1 px-3 py-6 space-y-1.5'>
                    {navLinks.map((link) => (
                        <NavLink
                            ...
                            to={link.to}
                            onClick={toggleSidebar}
                            className={({ isActive }) => `group flex items-center gap-3 px-4 py-2.5 text-sm font-semibold rounded-xl transition-all duration-200 ${isActive ? 'bg-gradient-to-r from-emerald-500 to-teal-500 text-white shadow-lg shadow-emerald-500/25'
                ...
                <div className='px-3 py-4 border-t border-slate-200/60'>
                    <button className='group flex items-center gap-3 w-full px-4 py-2.5 text-sm font-semibold text-slate-700 hover:text-red-600 rounded-xl transition-all duration-200'
