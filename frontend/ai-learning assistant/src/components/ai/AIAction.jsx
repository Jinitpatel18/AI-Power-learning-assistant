                    ...
                    <div className='group p-5 bg-linear-to-br from-slate-50/50 to-white rounded-xl border border-slate-200/60 hover:border-slate-300/60 hover:shadow-md transition-all duration-200'>
                        <form onSubmit={handleExplainConcept}>
                            ...
                            <p className='text-sm text-slate-600 leading-relaxed mb-4'>
                                Enter a topic or concept from the document to detailed
                                Explanation.
                            </p>
                            <div className='flex items-center gap-3'>
                                <input type="text"
                                ...
                                className='flex-1 h-11 px-4 border-2 bprder-slate-200 rounded-xl bg-slate-50/50 text-slate-900 placeholder-slate-400 text-sm font-medium transition-all duration-200 focus:outline-none focus:border-emerald-500 focus:bg-white focus:shadow-lg focus:shadow-purple-500/10'
                                disabled={loadingAction == "explain"}/>
                                <button className='shrink-0 h-11 px-5 bg-linear-to-br from-emerald-600 to-emerald-500 hover:from-emerald-600 hover:to-emerald-600 text-white text-sm font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-purple-500/25 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95'
                                type='Submit'
