...
const FlashcardSetCard = ({ flashcardSet }) => {
    ...
    const reviewedCount = useMemo(() => {
        if (!flashcardSet?.cards) return 0
        return flashcardSet.cards.filter(card => card.lastReviewed).length
    }, [flashcardSet?.cards])
        ...
        >
            <div className="space-y-4">
                ...
                <div className="flex items-start gap-4">
                    <div className="shrink-0 w-12 h-12 rounded-xl bg-gradient-to-r from-emerald-100 to-teal-100 flex items-center justify-center">
                ...
                {totalCards > 0 && (
                    <div className="space-y-2">
                        ...
                        <div className="relative h-2 bg-slate-100 rounded-full overflow-hidden">
                            <div
                                className="absolute inset-0 left-0 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full transition-all duration-500 ease-out"
