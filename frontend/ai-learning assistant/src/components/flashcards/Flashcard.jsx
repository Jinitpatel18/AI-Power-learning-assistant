...
const Flashcard = ({ flashcard, onToggleStar }) => {
    ...
    return (
        <div className='relative w-full h-72' style={{ perspective: '1000px' }}>
            <div className={'relative w-full h-full transition-transform duration-200 transform-gpu cursor-pointer'}
                style={{
                ...
                <div className='absolute inset-0 w-full h-full bg-white/80 backdrop-blur-xl border-2 border-slate-200/60 rounded-xl shadow-xl shadow-slate-200/50 p-8 flex flex-col justify-between'
                    style={{
                ...
                <div
                    className="absolute inset-0 w-full h-full bg-linear-to-br from-emerald-500 via-emerald-600 to-emerald-600 rounded-xl shadow-xl shadow-emerald-900/40 p-8 flex flex-col justify-between text-white"
                    style={{
                        backfaceVisibility: "hidden",
                        WebkitBackfaceVisibility: "hidden",
                ...
                >
                    ...
                    <div className="flex items-center justify-end">
                        <button
                            ...
                            className={`w-9 h-9 rounded-xl flex items-center justify-center transition-all duration-200 ${flashcard.isStarred
                                ? "bg-white/30 backdrop-blur-sm text-amber-400 border border-white/40"
                                : "bg-white/20 backdrop-blur-sm text-white/70 hover:bg-white/30 hover:text-amber-400 border border-white/20"
                                }`}
                        >
                            <Star
                                className="w-4 h-4"
