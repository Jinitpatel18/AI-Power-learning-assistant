            ...
            <div className='relative max-w-7xl mx-auto'>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    {stats.map((stat, index) => (
                        <div key={index}
                            className='group bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl p-6 hover:shadow-xl hover:shadow-slate-200/50 transition-all duration-300'>
                ...
                <div className='bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl p-6'>
                    ...
                    {dashboardData.recentActivity && (dashboardData.recentActivity.documents.length > 0 || dashboardData.recentActivity.quizzes.length > 0) ? (
                                    ...
                                    <div
                                        ...
                                        {activity.link && (
                                            <a href={activity.link}
                                                className='px-4 py-2 text-sm font-semibold text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50 rounded-lg transition-colors duration-200'>
                                                View
                                            </a>
                                        )}
                                    </div>
                        ...
                        <div className='text-center py-12'>
                            ...
                            <p className='text-slate-600 font-medium mb-1'>No recent activity yet.</p>
                            <p className='text-slate-500 text-sm'>Start learning to see your progress here</p>
                        </div>
                    )}
                </div>
            </div>
