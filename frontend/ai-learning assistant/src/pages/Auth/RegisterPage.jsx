...
//                                 </div>
//                                 <input type="password"
//                                 className="'w-full h-12 pl-12 pr-4 border-2 border-slate-200 rounded-xl bg-slate-50/50 text-slate-900 placeholder-slate-400 text-sm font-medium transition-all duration-200 focus:outline-none focus:border-emerald-500 focus:bg-white focus:shadow-lg focus:shadow-emerald-500/1"
//                                 value={password}
...
//                                     <>
//                                         Create account
//                                         <ArrowRight className='w-4 h-4 group-hover:translate-x transition-transform duration-200' strokeWidth={2.5} />
//                                     </>
//                                 )}
//                             </span>
                ...
                <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl shadow-xl p-10">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    value={username}
                                    onChange={(e) => setUsername(e.target.value)}
                                    className="w-full h-12 pl-12 pr-4 border-2 border-slate-200 rounded-xl bg-slate-50 text-slate-900 placeholder-slate-400 transition-all duration-200 focus:outline-none focus:ring-0 focus:border-emerald-500"
                                    placeholder="your username"
                                />
                            </div>
                        </div>
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full h-12 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-xl font-semibold hover:to-teal-600 transition"
                        >
