    ...
    const handleSubmitQuiz = async () => {
        ...
        try {
            const answersArray = quiz.questions
                ...
                .filter(ans => ans.selectedAnswer !== undefined)
                ...
                {quiz.questions.map((_, index) => {
                    ...
                    return (
                        <button
                            ...
                            disabled={submitting}
                            className={`w-8 h-8 rounded-lg font-semibold text-xs transition-all duration-200 ${isCurrent ? 'bg-linear-to-r from-emerald-500 to-teal-500 text-white shadow-lg shadow-emerald-500/25 scale-110'
                                : isAnsweredQuestion ?
